...
static bool R_Mem_Profiling=0;
static bool R_GC_Profiling = 0;                     /* indicates GC profiling */
...
static bool R_Filter_Callframes = 0;	      	   /* whether to record only the trailing branch of call trees */
