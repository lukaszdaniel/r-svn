...
// finding memory protection errors very simple.
    ...
    const unsigned char MemoryBank::s_pooltab[] = {0, 0,                    // 0, 8
                                                   1,                       // 16
                                                   2,                       // 24
                                                   3,                       // 32
                                                   4,                       // 40
                                                   ...
                                                   6, 6,                    // 56, 64
                                                   7, 7, 7, 7,              // 72, 80, 88, 96
                                                   8, 8, 8, 8,              // 104, 112, 120, 128
                                                   9, 9, 9, 9, 9, 9, 9, 9}; // 136, 144, 152, 160, 168, 176, 184, 192
    ...
    {
        s_monitor = monitor;
        s_monitor_threshold = (monitor ? threshold : std::numeric_limits<size_t>::max());
    }
#endif
