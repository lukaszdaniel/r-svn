...
namespace CXXR
{
    ...
    namespace ElementTraits
    {
         ...
         */
        template <typename T>
        struct MustConstruct: public std::true_type
        {
        };
         ...
         */
        template <typename T>
        struct MustDestruct: public std::true_type
        {
        };
        ...
        struct Duplicate
        {
            T operator()(const T &value, Duplication depth) const
            {
                return value;
            }
        };
        ...
        template <class T>
        auto duplicate_element(const T &value, Duplication depth)
            -> decltype(Duplicate<T>()(value, depth))
        {
            return Duplicate<T>()(value, depth);
        }
