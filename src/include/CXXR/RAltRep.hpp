...
/** @file RAltRep.hpp
 * @brief Class CXXR::AltRep and associated C interface.
 */
...
namespace CXXR
{
    ...
    public:
        /**
         * @param data1 Pointer to the 'car' of the element to be
         *           constructed.
         *
         * @param data2 Pointer to the 'tail' (LISP cdr) of the element
         *           to be constructed.
         *
         * @param sclass Pointer to the 'tag' of the element to be constructed.
         */
        static AltRep *create(SEXP data1 = R_NilValue, SEXP data2 = R_NilValue, SEXP sclass = R_NilValue);

        /** @brief Is an RObject an AltRep?
         *
         * @param obj Pointer to RObject to be tested.  This may be a
         *          null pointer, in which case the function returns
         *          false.
         *
         * @return true iff \a obj is an AltRep.
         */
