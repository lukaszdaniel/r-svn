/* From https://www.netlib.org/specfun/gamma	Fortran translated by f2c,...
...
/* ----------------------------------------------------------------------
   ...
   ----------------------------------------------------------------------*/
    constexpr double sqrtpi = M_LN_SQRT_2PI; /* == ln(2*pi)/2 */
