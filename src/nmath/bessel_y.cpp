...
static constexpr double max_alpha_y = M_bessel_y_max_alpha;
 ...
 *******************************************************************
 ...
 ----------------------------------------------------------------------*/
	...
	if (nu == -.5) {
	     ...
	     * --------------------------------------------------------------------------- */
	    constexpr double ch[21] = { -6.7735241822398840964e-24,
	...
	L220:
	    ...
	    constexpr double fivpi = 15.707963267948966192 ; // = 5 * pi
	    constexpr double pim5  =   .70796326794896619231;// = 5 * pi - 15
